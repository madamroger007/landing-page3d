...
const categories = ["Artwork", "Music", "Photography", "Sports", "Videos", "Virtual Reality"];

const nftItems = [
    { id: 1, name: "Cyber Warrior #01", price: "2.5 ETH", likes: "1.2k" },
    { id: 2, name: "Neon Matrix #45", price: "1.8 ETH", likes: "850" },
    { id: 3, name: "Ape Rebel #11", price: "4.2 ETH", likes: "2.4k" },
    { id: 4, name: "Future Soul #99", price: "0.9 ETH", likes: "420" },
    { id: 5, name: "Digital Ghost #07", price: "3.1 ETH", likes: "1.1k" },
];
    ...
    return (
        <div id="collection">
            <div className="text-center mb-16">
                ...
                <h2 className="text-4xl md:text-6xl font-syne font-bold mb-8">Our Popular Collection</h2>
                <div className="w-24 h-1 bg-gradient-to-r from-neon-blue to-neon-purple mx-auto rounded-full mb-12" />
            </div>
